...
- [`android/`](android): All your `android`-specific implementations.
  - [`build.gradle`](android/build.gradle): The gradle build file. This contains four important pieces:
    ...
    3. Adds all Nitrogen files (`apply from: '.../TurboScryptCxxLib+autolinking.gradle'`)
  ...
  - [`CMakeLists.txt`](android/CMakeLists.txt): The CMake build file to build C++ code. This contains four important pieces:
    1. Creates a library called `TurboScryptCxxLib` (same as in `nitro.json`)
    2. Adds all Nitrogen files (`include(.../TurboScryptCxxLib+autolinking.cmake)`)
  ...
  - [`src/main/java/com/margelo/nitro/TurboScrypt/`](android/src/main/java/com/margelo/nitro/TurboScrypt/): All Kotlin implementations.
    - [`TurboScryptCxxLibPackage.java`](android/src/main/java/com/margelo/nitro/TurboScrypt/TurboScryptCxxLibPackage.java): The react-native package. You need this because the react-native CLI only adds libraries if they have a `*Package.java` file. In here, you can autolink all Kotlin HybridObjects.
...
- [`react-native-turbo-scrypt.podspec`](react-native-turbo-scrypt.podspec): The iOS podspec build file to build the iOS code. This contains three important pieces:
