...
- [`android/`](android): All your `android`-specific implementations.
  ...
  - [`src/main/java/com/margelo/nitro/TurboScryptAndroid/`](android/src/main/java/com/margelo/nitro/TurboScryptAndroid/): All Kotlin implementations.
    - [`TurboScryptCxxLibPackage.java`](android/src/main/java/com/margelo/nitro/TurboScryptAndroid/TurboScryptCxxLibPackage.java): The react-native package. You need this because the react-native CLI only adds libraries if they have a `*Package.java` file. In here, you can autolink all Kotlin HybridObjects.
...
- [`TurboScryptiOS.podspec`](TurboScryptiOS.podspec): The iOS podspec build file to build the iOS code. This contains three important pieces:
